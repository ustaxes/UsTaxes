...
export default class Schedule8812 implements Form {
  ...
  l9 = (): number | undefined => this.l9checkBox() ? this.ssWithholding() + this.medicareWithholding() : undefined

  l10 = (): number | undefined => this.l9checkBox() ? sumFields([this.f1040.schedule1?.l14(), this.f1040.schedule2?.l5(), this.f1040.schedule2?.l8()]) : undefined

  l11 = (): number | undefined => this.l9checkBox() ? computeField(this.l9()) + computeField(this.l10()) : undefined

  // TODO: Add 1040-NR
  l12 = (): number | undefined => this.l9checkBox() ? sumFields([this.f1040.l27(), this.f1040.schedule3?.l10()]) : undefined

  l13 = (): number | undefined => this.l9checkBox() ? computeField(this.l11()) - computeField(this.l12()) > 0 ? computeField(this.l11()) - computeField(this.l12()) : 0 : undefined

  l14 = (): number | undefined => this.l9checkBox() ? Math.max(computeField(this.l8()), computeField(this.l13())) : undefined

  l15 = (): number | undefined => this.l9checkBox() ? Math.min(computeField(this.l14()), computeField(this.l5())) : computeField(this.l5())
