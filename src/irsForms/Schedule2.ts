...
export default class Schedule2 implements Form {
  ...
  l3 = (): number | undefined => displayNumber(
  ...
  l10 = (): number | undefined => sumFields([
    this.l4(),
    this.l5(),
    this.l6(),
    this.l7a(),
  ...
  fields = (): Array<string | number | boolean | undefined> => {
    return [
      ...
      this.l4(),
      undefined, undefined /* checkboxes */, this.l5(),
      this.l6(),
      this.l7a(),
      this.l7b(),
      this.f8959 !== undefined, // 8959 checkbox
      undefined, undefined, undefined, // Form 8960 checkbox and 'instructions' checkbox and textbox
      this.l8(),
      this.l9(),
      this.l10()
    ]
