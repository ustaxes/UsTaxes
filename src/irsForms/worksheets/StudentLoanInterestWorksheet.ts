...
export default class StudentLoanInterestWorksheet {
  ...
  l4 = (): number | undefined => computeField(this.l2()) - computeField(this.l3())

  l5 = (): number => this.f1040.filingStatus === FilingStatus.MFJ ? 140000 : 70000

  l6 = (): number | undefined => computeField(this.l4()) > computeField(this.l5()) ? computeField(this.l4()) - computeField(this.l5()) : 0

  l7 = (): number | undefined => Math.min(computeField(this.l6()) / 15000, 1)

  l8 = (): number | undefined => computeField(this.l1()) * computeField(this.l7())

  l9 = (): number | undefined => this.notMFS() && this.isNotDependent() ? displayNumber(computeField(this.l1()) - computeField(this.l8())) : undefined
}
