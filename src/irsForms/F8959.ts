...
export const needsF8959 = (state: Information): boolean => {
  ...
  const totalW2Income = state.w2s.map((w2) => w2.income).reduce((l, r) => l + r, 0)
...
export default class F8959 implements Form {
  ...
  constructor (state: Information, f4137?: F4137, f8919?: F8919, scheduleSE?: ScheduleSE) {
    this.state = state
    this.f4137 = f4137
    this.f8919 = f8919
  ...
  l12 = (): number | undefined => displayNumber(
  ...
  l18 = (): number | undefined => displayNumber(
    computeField(this.l7()) + computeField(this.l3()) + computeField(this.l17())
  )
  ...
  l21 = (): number | undefined => 0.0145 * computeField(this.l20())
  ...
  l24 = (): number | undefined => displayNumber(
    computeField(this.l22()) + computeField(this.l23())
  )
