...
export default class F8995A extends F8995 {
  ...
  l3a = (): number | undefined =>
    ifNumber(this.l2a(), (num) => Math.round(num * 0.2))
  l3b = (): number | undefined =>
    ifNumber(this.l2b(), (num) => Math.round(num * 0.2))
  l3c = (): number | undefined =>
    ifNumber(this.l2c(), (num) => Math.round(num * 0.2))
  ...
  l5a = (): number | undefined =>
    ifNumber(this.l4a(), (num) => Math.round(num * 0.5))
  ...
  l6a = (): number | undefined =>
    ifNumber(this.l4a(), (num) => Math.round(num * 0.25))
  l6b = (): number | undefined =>
    ifNumber(this.l4a(), (num) => Math.round(num * 0.25))
  l6c = (): number | undefined =>
    ifNumber(this.l4a(), (num) => Math.round(num * 0.25))
  ...
  l8a = (): number | undefined =>
    ifNumber(this.l7a(), (num) => Math.round(num * 0.25))
  ...
  l24 = (): number => parseFloat((this.l22() / this.l23()).toFixed(3))

  l25a = (): number | undefined =>
    ifNumber(this.l19a(), (num) => Math.round(num * this.l24()))
  l25b = (): number | undefined =>
    ifNumber(this.l19b(), (num) => Math.round(num * this.l24()))
  l25c = (): number | undefined =>
    ifNumber(this.l19c(), (num) => Math.round(num * this.l24()))
