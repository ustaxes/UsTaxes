...
export default class Schedule2 extends F1040Attachment {
  ...
  l1a = (): number | undefined =>
    this.f1040.f8962.excessRepayment() ??
    this.f1040.info.otherIncome?.excessAdvancePTC
  l1b = (): number | undefined =>
    this.f1040.info.otherIncome?.newCleanVehicleCreditRepayment
  l1c = (): number | undefined =>
    this.f1040.info.otherIncome?.previouslyOwnedCleanVehicleCreditRepayment
  ...
  l13 = (): number | undefined => {
    const total = [W2Box12Code.A, W2Box12Code.B, W2Box12Code.M, W2Box12Code.N]
      .map((code) => this.f1040.sumW2Box12Code(code))
  ...
  l17aDesc = (): string | undefined =>
    this.f1040.info.otherIncome?.otherAdditionalTaxDescription
  l17a = (): number | undefined =>
    this.f1040.info.otherIncome?.otherAdditionalTax
  ...
  // 62 TS expressions, 63 PDF fields
  fillInstructions = (): FillInstructions => [
    ...
    text('form1[0].Page2[0].f2_24[0]', this.l21())
  ]
}
