...
export default class Schedule1 extends F1040Attachment {
  ...
  fillInstructions = (): FillInstructions => [
    ...
    text('topmostSubform[0].Page1[0].f1_04[0]', this.l2a()),
    text('topmostSubform[0].Page1[0].f1_05[0]', this.l2b()),
    text('topmostSubform[0].Page1[0].f1_06[0]', this.l3()),
    text('topmostSubform[0].Page1[0].f1_07[0]', this.l4()),
    checkbox('topmostSubform[0].Page1[0].c1_1[0]', false),
    checkbox('topmostSubform[0].Page1[0].c1_2[0]', false),
    text('topmostSubform[0].Page1[0].f1_08[0]', this.l5()),
    text('topmostSubform[0].Page1[0].f1_09[0]', this.l6()),
    text('topmostSubform[0].Page1[0].f1_10[0]', this.l7()),
    checkbox('topmostSubform[0].Page1[0].Line7_ReadOrder[0].c1_3[0]', false),
    text('topmostSubform[0].Page1[0].Line7_ReadOrder[0].f1_11[0]', undefined),
    text('topmostSubform[0].Page1[0].f1_12[0]', this.l8a()),
    text('topmostSubform[0].Page1[0].Line8a_ReadOrder[0].f1_13[0]', this.l8b()),
    text('topmostSubform[0].Page1[0].f1_14[0]', this.l8c()),
    text('topmostSubform[0].Page1[0].f1_15[0]', this.l8d()),
    text('topmostSubform[0].Page1[0].f1_16[0]', this.l8e()),
    text('topmostSubform[0].Page1[0].f1_17[0]', this.l8f()),
    text('topmostSubform[0].Page1[0].f1_18[0]', this.l8g()),
    text('topmostSubform[0].Page1[0].f1_19[0]', this.l8h()),
    text('topmostSubform[0].Page1[0].f1_20[0]', this.l8i()),
    text('topmostSubform[0].Page1[0].f1_21[0]', this.l8j()),
    text('topmostSubform[0].Page1[0].f1_22[0]', this.l8k()),
    text('topmostSubform[0].Page1[0].f1_23[0]', this.l8l()),
    text('topmostSubform[0].Page1[0].f1_24[0]', this.l8m()),
    text('topmostSubform[0].Page1[0].f1_25[0]', this.l8n()),
    text('topmostSubform[0].Page1[0].f1_26[0]', this.l8o()),
    text('topmostSubform[0].Page1[0].f1_27[0]', this.l8p()),
    text('topmostSubform[0].Page1[0].f1_28[0]', this.l8q()),
    text('topmostSubform[0].Page1[0].f1_29[0]', this.l8r()),
    text('topmostSubform[0].Page1[0].f1_30[0]', this.l8s()),
    text('topmostSubform[0].Page1[0].f1_31[0]', this.l8t()),
    text('topmostSubform[0].Page1[0].f1_32[0]', this.l8u()),
    text('topmostSubform[0].Page1[0].f1_33[0]', this.l8v()),
    text(
      'topmostSubform[0].Page1[0].f1_34[0]',
      Array.from(this.otherIncomeStrings).join(' ')
    ),
    text('topmostSubform[0].Page1[0].Line8z_ReadOrder[0].f1_35[0]', this.l8z()),
    text('topmostSubform[0].Page1[0].f1_36[0]', this.l9()),
    text('topmostSubform[0].Page1[0].f1_37[0]', this.l10()),
    text('topmostSubform[0].Page1[0].f1_38[0]', this.l11()),
    text('topmostSubform[0].Page2[0].f2_01[0]', this.l12()),
    text('topmostSubform[0].Page2[0].f2_02[0]', this.l13()),
    text('topmostSubform[0].Page2[0].f2_03[0]', this.l14()),
    checkbox('topmostSubform[0].Page2[0].c2_1[0]', false),
    text('topmostSubform[0].Page2[0].f2_04[0]', this.l15()),
    text('topmostSubform[0].Page2[0].f2_05[0]', this.l16()),
    text('topmostSubform[0].Page2[0].f2_06[0]', this.l17()),
    text('topmostSubform[0].Page2[0].f2_07[0]', this.l18()),
    text('topmostSubform[0].Page2[0].f2_08[0]', this.l19a()),
    text('topmostSubform[0].Page2[0].f2_09[0]', this.l19b()),
    text(
      'topmostSubform[0].Page2[0].Line19b_CombField[0].f2_10[0]',
      this.l19c()
    ),
    text('topmostSubform[0].Page2[0].f2_11[0]', this.l20()),
    checkbox('topmostSubform[0].Page2[0].c2_2[0]', false),
    text('topmostSubform[0].Page2[0].f2_12[0]', this.l21()),
    text('topmostSubform[0].Page2[0].f2_13[0]', this.l23()),
    text('topmostSubform[0].Page2[0].f2_14[0]', this.l24a()),
    text('topmostSubform[0].Page2[0].f2_15[0]', this.l24b()),
    text(
      'topmostSubform[0].Page2[0].Line24a_ReadOrder[0].f2_16[0]',
      this.l24c()
    ),
    text('topmostSubform[0].Page2[0].f2_17[0]', this.l24d()),
    text('topmostSubform[0].Page2[0].f2_18[0]', this.l24e()),
    text('topmostSubform[0].Page2[0].f2_19[0]', this.l24f()),
    text('topmostSubform[0].Page2[0].f2_20[0]', this.l24g()),
    text('topmostSubform[0].Page2[0].f2_21[0]', this.l24h()),
    text('topmostSubform[0].Page2[0].f2_22[0]', this.l24i()),
    text('topmostSubform[0].Page2[0].f2_23[0]', this.l24j()),
    text('topmostSubform[0].Page2[0].f2_24[0]', this.l24k()),
    text('topmostSubform[0].Page2[0].f2_25[0]', this.l24zDesc()),
    text('topmostSubform[0].Page2[0].f2_26[0]', this.l24zDesc2()),
    text(
      'topmostSubform[0].Page2[0].Line24z_ReadOrder[0].f2_27[0]',
      this.l24z()
    ),
    text('topmostSubform[0].Page2[0].f2_28[0]', this.l25()),
    text('topmostSubform[0].Page2[0].f2_29[0]', this.l26()),
    text('topmostSubform[0].Page2[0].f2_30[0]', undefined)
  ]
}
