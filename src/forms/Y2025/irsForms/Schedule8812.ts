...
export default class Schedule8812 extends F1040Attachment {
  ...
  fillInstructions = (): FillInstructions => {
    ...
    return [
      ...
      text('topmostSubform[0].Page2[0].f2_9[0]', part2a.l20),
      checkbox('topmostSubform[0].Page2[0].c2_2[0]', part2a.l20No),
      checkbox('topmostSubform[0].Page2[0].c2_2[1]', part2a.l20Yes),
      text('topmostSubform[0].Page2[0].f2_10[0]', part2b.l21),
      text('topmostSubform[0].Page2[0].f2_11[0]', part2b.l22),
      text('topmostSubform[0].Page2[0].f2_12[0]', part2b.l23),
      text('topmostSubform[0].Page2[0].f2_13[0]', part2b.l24),
      text('topmostSubform[0].Page2[0].f2_14[0]', part2b.l25),
      text('topmostSubform[0].Page2[0].f2_15[0]', part2b.l26),
